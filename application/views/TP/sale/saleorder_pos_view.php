            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
							<div class="col-md-6">
                                <a href="<?php echo site_url("sale/saleorder_rolex_print")."/".$pos_rolex_id; ?>"><button type="button" class="btn btn-primary" name="printbtn" id="printbtn"><i class='fa fa-print'></i>  พิมพ์ใบกำกับภาษี </button></a>&nbsp;&nbsp;
							</div>
						</div>

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group-lg">
                                    ...
                                    <input type="text" class="form-control input-lg text-blue" name="payment_value" id="payment_value" style="font-weight:bold;" value="<?php echo number_format($loop->posrot_payment_value); ?>" onchange="numberWithCommas(this);">
                                </div>
							</div> 
                        </div>

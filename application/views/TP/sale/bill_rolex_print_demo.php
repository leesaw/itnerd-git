...
<thead>
	<tr>
		<th width="30" style="border-bottom:1px solid black;">No.</th><th width="350" style="border-left:1px solid black;border-bottom:1px solid black;">รายละเอียดสินค้า</th><th width="50" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวน</th><th width="120" style="border-left:1px solid black;border-bottom:1px solid black;">หน่วยละ</th><th width="140" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวนเงิน</th>
	</tr>
</thead>
<tbody>
...
<tbody>
<tr>
<td align="right" colspan=4 scope="row" style="border-top:1px solid black;">รวมเป็นเงิน&nbsp;&nbsp;</td><td align="right" style="border-top:1px solid black; border-left:1px solid black;"><?php  echo number_format($sum/1.07, 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
<tr>
<td align="right" colspan=4 scope="row"><u>หัก</u>&nbsp;ส่วนลด&nbsp;&nbsp;</td><td align="right" style="border-left:1px solid black;"><?php echo number_format(0, 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
<tr>
<td align="right" colspan=4 scope="row">จำนวนเงินหลังหักส่วนลด&nbsp;&nbsp;</td><td align="right" style="border-left:1px solid black;"><?php echo number_format($sum/1.07, 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
<tr>
<td align="right" colspan=4 scope="row">จำนวนภาษีมูลค่าเพิ่ม&nbsp;&nbsp;7 %&nbsp;&nbsp;</td><td align="right" style="border-left:1px solid black;"><?php echo number_format(($sum/1.07)*0.07, 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
<tr>
<td height="40" align="left" colspan=2 scope="row" style="border-top:1px solid black;">( <?php echo num2thai($sum); ?> )</td>

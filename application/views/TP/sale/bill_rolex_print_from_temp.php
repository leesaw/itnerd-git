...
<?php foreach($pos_array as $loop) { $datetime = $loop->posrot_issuedate; $so_id = $loop->posrot_number; $editor = $loop->firstname." ".$loop->lastname; $shop = $loop->sh_name; $cusname = $loop->posrot_customer_name; $cusaddress = $loop->posrot_customer_address; $custaxid = $loop->posrot_customer_taxid; $cuspassport = $loop->posrot_customer_passport; break; }
...
<?php foreach($pos_array as $loop) { $datetime = $loop->posrot_issuedate; $so_id = $loop->posrot_number; $editor = $loop->firstname." ".$loop->lastname; $shop = $loop->sh_name; $cusname = $loop->posrot_customer_name; $cusaddress = $loop->posrot_customer_address; $custaxid = $loop->posrot_customer_taxid; break; }

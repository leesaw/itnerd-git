...
<td width="50"> </td>
<?php foreach($stock_array as $loop) { $stoi_status = $loop->stoi_status; $datetime = $loop->stoi_datein; $si_id = $loop->stoi_number; $editor = $loop->firstname." ".$loop->lastname; $stock_name = $loop->wh_code."-".$loop->wh_name; $dateadd = $loop->stoi_dateadd; $remark = $loop->stoi_remark; break; }
...
?>
<td width="200"><div style="text-align: right; font-weight: bold; font-size: 16pt;">ใบรายการสินค้ารับเข้าคลัง <?php if ($stoi_status == 'V') echo "<p style='color: red;'>ยกเลิกแล้ว</p>"; ?></div></td>
</tr>
<tr>
    <td>คลังที่รับเข้า : <?php echo $stock_name; ?><br>ชื่อผู้ใส่ข้อมูล:  <?php echo $editor; ?><br>Remark: <?php echo $remark; ?></td><td> </td><td>เลขที่ <?php echo $si_id; ?><br> วันที่ : <?php echo $GGdate."/".$GGmonth."/".$GGyear; ?><br>วันที่บันทึก : <?php echo $dateadd; ?>
    </td>
</tr>
</tbody>
</table>
...
<thead>
	<tr>
		<th width="30" style="border-bottom:1px solid black;">No.</th><th width="280" style="border-left:1px solid black;border-bottom:1px solid black;">Ref. Number/รายละเอียดสินค้า</th><th width="80" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวน<br>ในคลัง</th><th width="80" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวน<br>รับเข้า</th>
    <th width="80" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวน<br>ในคลังหลังรับเข้า</th><th width="100" style="border-left:1px solid black;border-bottom:1px solid black;">หน่วยละ</th><th width="120" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวนเงิน</th>
	</tr>
</thead>
<tbody>

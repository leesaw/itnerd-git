...
function confirmform(luxury)
{
    ...
    if (luxury==1) {
        ...
        $.ajax({
            type : "POST" ,
            url : "<?php echo site_url("warehouse_transfer/save_out_stock/1"); ?>" ,
            data : {datein: datein, whid_out: whid_out, item: it_array, stot_remark: stot_remark} ,
            dataType: 'json',
            success : function(data) {
        ...
        $.ajax({
            type : "POST" ,
            url : "<?php echo site_url("warehouse_transfer/save_out_stock/0"); ?>" ,
            data : {datein: datein, whid_out: whid_out, item: it_array, stot_remark: stot_remark} ,
            dataType: 'json',
            success : function(data) {
                var message = "สินค้าจำนวน "+data.a+" ชิ้น  ทำการบันทึกเรียบร้อยแล้ว <br><br>คุณต้องการพิมพ์ใบเอาสินค้าออกจากคลัง ใช่หรือไม่";

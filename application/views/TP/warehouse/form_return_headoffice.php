...
<body class="skin-red">
	...
	<?php $this->load->view('menu'); ?>
        ...
        <section class="content-header">
            ...
            <h1>คืนสินค้าเข้าคลัง Head Office</h1>
        </section>
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-2">
                                <form action="<?php echo site_url("warehouse_transfer/form_return_headoffice_select_item"); ?>" name="form1" id="form1" method="post">
                            ...
                            <div class="col-md-3">
									<div class="form-group-sm">
                                        ...
                                        <select class="form-control select2" name="whid_in" id="whid_in" style="width: 100%;">
                                            <option value='-1'>-- เลือกคลังสินค้า --</option>
										<?php 	if(is_array($wh_ho)) {
												foreach($wh_ho as $loop){
													echo "<option value='".$loop->wh_id."#".$loop->wh_code."-".$loop->wh_name."'>".$loop->wh_code."-".$loop->wh_name."</option>";
										 } } ?>
                                        </select>
                                    </div>

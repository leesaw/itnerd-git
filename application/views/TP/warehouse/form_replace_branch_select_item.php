              ...
              <input type="radio" name="watch_luxury" id="watch_luxury" value="1" <?php if ($remark=='1') echo "checked"; ?> disabled> <label class="text-red"> Caseback</label>
                        ...
                        <div class="row">
							<div class="col-md-6">
                                ...
                                <a href="<?php echo site_url("warehouse_transfer/form_replace_branch"); ?>"><button type="button" class="btn btn-danger" name="resetbtn" id="resetbtn"><i class='fa fa-rotate-left'></i>  เริ่มต้นใหม่ </button></a>
							</div>
						</div>
						</form>
...
function confirmform(luxury)
{
    ...
    if (luxury==1) {
        ...
        $.ajax({
            type : "POST" ,
            url : "<?php echo site_url("warehouse_transfer/save_replace_branch/1"); ?>" ,
            ...
            success : function(data) {
                ...
                bootbox.confirm(message, function(result) {
                        ...
                        if (result) {
                            ...
                            window.location = "<?php echo site_url("warehouse_transfer/form_replace_branch"); ?>";
                        }else{
                            window.location = "<?php echo site_url("warehouse_transfer/form_replace_branch"); ?>";
                        }
        ...
        $.ajax({
            type : "POST" ,
            url : "<?php echo site_url("warehouse_transfer/save_replace_branch/0"); ?>" ,
            data : {datein: datein, whid_out: whid_out, whid_in: whid_in, item: it_array, stot_remark: stot_remark} ,
            dataType: 'json',
            success : function(data) {
                var message = "สินค้าจำนวน "+data.a+" ชิ้น  ทำการบันทึกเรียบร้อยแล้ว <br><br>คุณต้องการพิมพ์ใบส่งของ ใช่หรือไม่";

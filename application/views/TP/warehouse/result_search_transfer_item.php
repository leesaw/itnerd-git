			...
			<div class="col-xs-12">
                <div class="panel panel-default">
					<div class="panel-heading">
                        <form name="exportexcel" action="<?php echo site_url("warehouse_transfer/exportExcel_transfer_report"); ?>" method="post">
...
{    
    var oTable = $('#tablebarcode').DataTable({
        ...
        'bServerSide'    : false,
        "bDeferRender": true,
        'sAjaxSource'    : '<?php echo site_url("warehouse_transfer/ajaxView_seach_transfer")."/".$refcode."/".$brand_id."/".$wh_id."/".$startdate."/".$enddate; ?>',

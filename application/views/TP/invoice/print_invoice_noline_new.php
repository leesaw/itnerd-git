...
<tr><td width="250"></td><td width="200"><?php if ($custaxid != '-') echo $custaxid; else echo "<br>"; ?></td><td><?php echo $GGdate."/".$GGmonth."/".$GGyear; ?></td><td width="120"></td><td><?php echo $number; ?></td></tr>
...
<tr>
	<td width="50"></td>
    <td width="380" style="border-right:0px solid black;" valign="top"><?php if ($cusname != '-') echo $cusname; else echo "<br>"; ?><br><?php if ($cusaddress1 != '-') echo $cusaddress1; else echo "<br>"; ?><br><?php if ($cusaddress2 != '-') echo $cusaddress2; else echo "<br>"; ?></td><td width="20"> </td><td width="50" valign="top"></td><td width="180" valign="top"></td>
</tr>
...
<table style="border:0px solid black; border-spacing:0px 0px;">
<tbody>
<tr><td width="8"></td><td width="20"><?php if ($mainbranch==1 && $custaxid != '-') echo $checkmark; else echo "<br>"; ?></td><td width="75"></td><td width="8"></td><td><?php if ($mainbranch==0 && $custaxid != '-') echo $checkmark; else echo "<br>"; ?></td><td width="60"></td><td width="280"><?php if ($mainbranch==0 && $custaxid != '-') echo $branch_number; else echo "<br>"; ?></td><td><?php echo $note; ?></td></tr>
...
<?php }else{ ?>
<tr><td height="10" width="10"></td><td width="110"></td><td width="300"></td><td width="80"></td><td width="80"></td><td width="70"></td><td width="100"></td></tr>
<?php } ?>
<!--

            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                    <div class="form-group-sm has-success">
                                        <label class="control-label" for="inputSuccess">เลขที่ใบรับสินค้าคืน</label>
                                            <input type="text" class="form-control" name="datein" id="datein" value="<?php echo $loop->posrob_number; ?>" readonly>
                                    </div>
							</div>
                            <div class="col-md-2">
                                    <div class="form-group-sm has-success">
                                        <label class="control-label" for="inputSuccess">วันที่รับคืน</label>
                        ...
                        <div class="row">
							<div class="col-md-6">
                                <a href="<?php echo site_url("pos/stock_rolex_borrow_return_print")."/".$pos_rolex_id; ?>" target="_blank"><button type="button" class="btn btn-primary" name="printbtn" id="printbtn"><i class='fa fa-print'></i>  พิมพ์ใบรับสินค้าคืน </button></a>&nbsp;&nbsp;
							</div>
						</div>

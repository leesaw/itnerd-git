...
<body class="skin-red">
	...
	<?php $this->load->view('menu'); ?>
        ...
        <section class="content-header">
            ...
            <h1>แก้ไขข้อมูล Bar ห้าง</h1>

<?php
foreach($bar_array as $loop) {
    $sbid = $loop->sb_id;
    $sbnumber = $loop->sb_number;
    $sbname = $loop->sb_brand_name;
    $sgid = $loop->sb_shop_group_id;
    $brid = $loop->sb_item_brand_id;
    $dc = $loop->sb_discount_percent;
    $gp = $loop->sb_gp;
}
?>
        </section>
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-3">
                                <form name="form1" id="form1" action="<?php echo site_url('shop/save_edit_bar'); ?>" method="post">
                                  <input type="hidden" name="sbid" value="<?php echo $sbid; ?>">
                                    <div class="form-group">
                                            Bar *
                                            <input type="text" class="form-control" name="sbnumber" id="sbnumber" value="<?php echo $sbnumber; ?>">
                                    </div>
							</div>
                            <div class="col-md-2">
									<div class="form-group">
                                            ชื่อ Bar *
                                            <input type="text" class="form-control" name="sbname" id="sbname" value="<?php echo $sbname; ?>">
                                    </div>
							</div>
							<div class="col-md-3">
									<div class="form-group">
                          ...
                          if ($loop->sg_id == $sgid) echo " selected";
              ...
              <div class="col-md-3">
                          ...
                          if ($loop->br_id == $brid) echo " selected";
                          echo ">".$loop->br_name."</option>";
										 } } ?>
                                        </select>
                                    </div>
							</div>
						...
						<div class="row">
							<div class="col-md-3">
									<div class="form-group">
                    ส่วนลด % *
                    <input type="text" class="form-control" name="dc" id="dc" value="<?php echo $dc; ?>">
                    <p class="help-block"><?php echo form_error('dc'); ?></p>
							...
							<div class="col-md-3">
								<div class="form-group">
									GP % *
									<input type="text" class="form-control" name="gp" id="gp" value="<?php echo $gp; ?>">

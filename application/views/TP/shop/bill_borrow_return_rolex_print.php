...
<thead>
	<tr>
		<th width="30" style="border-bottom:1px solid black;">No.</th><th width="100" style="border-left:1px solid black;border-bottom:1px solid black;">Serial Number</th><th width="180" style="border-left:1px solid black;border-bottom:1px solid black;">รายละเอียดสินค้า</th><th width="70" style="border-left:1px solid black;border-bottom:1px solid black;">รับคืนจาก</th><th width="50" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวน</th><th width="120" style="border-left:1px solid black;border-bottom:1px solid black;">หน่วยละ</th><th width="140" style="border-left:1px solid black;border-bottom:1px solid black;">จำนวนเงิน</th>
	</tr>
</thead>
<tbody>
...
<td align="center" style="border-left:1px solid black;" valign="top"><?php echo $loop->posrob_borrower_name; ?></td>
...
<tr><td style="border-top:1px solid black;">&nbsp;</td><td style="border-top:1px solid black;">&nbsp;</td><td style="border-top:1px solid black;">&nbsp;</td><td align="right" style="border-top:1px solid black; border-left:1px solid black;">รวมจำนวน</td><td align="center" style="border-top:1px solid black; border-left:1px solid black;"><?php echo $sum_qty; ?></td><td align="right" style="border-left:1px solid black;border-top:1px solid black;">รวมเงิน</td><td align="right" style="border-left:1px solid black;border-top:1px solid black;"><?php echo number_format($sum, 2, '.', ',')."&nbsp;&nbsp;"; ?></td></tr>
</tbody>
</table>
...
<tr>
<td width="170" align="center" style="border-left:1px solid black; border-top:1px solid black;"><br>ผู้ส่งคืน / Delivered By</td><td width="170" align="center" style="border-left:1px solid black; border-right:1px solid black; border-top:1px solid black;"><?php echo $editor; ?><br>ผู้รับของ / Receiver</td>
</tr>
</tbody>
</table>

...
<?php foreach($stock_array as $loop) { $datetime = $loop->onDate; $editor = $loop->firstname." ".$loop->lastname; $stockdetail = $loop->stockdetail; $status = $loop->stockstatus; $carnumber = $loop->carNumber; $customername = $loop->customerName; $listid=$loop->olistid; break; } 
...
?>
<tr>
    <td>เลขที่ <?php echo $listid; ?><br>วันที่ : <?php echo $GGdate."/".$GGmonth."/".$GGyear; ?> เวลา : <?php echo $time; ?></td><td> </td><td> ชื่อผู้ใส่ข้อมูล:  <?php echo $editor; ?>
    </td>
</tr>
<tr>

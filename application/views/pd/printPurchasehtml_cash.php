...
$discount=$loop->pdiscount; $discount2=$loop->pdiscountpercent;  $percentvat=$loop->percentvat; $tax=$loop->tax;
...
<tr>
<td align="right" colspan=4 scope="row">จำนวนภาษีมูลค่าเพิ่ม&nbsp;&nbsp;<?php echo $percentvat; ?> %&nbsp;&nbsp;</td><td align="right" style="border-left:1px solid black;"><?php if ($vat >0) echo number_format($tax, 2, '.', ',')."&nbsp;&nbsp;"; else echo number_format(0, 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
<tr>
<td align="left" colspan=2 scope="row" style="border-top:1px solid black;">( <?php if ($vat >0) echo num2thai($sum-($discount+($sum*$discount2/100))+$tax); else echo num2thai($sum-($discount+($sum*$discount2/100))); ?> )</td>
<td align="right" colspan=2 scope="row" style="border-top:1px solid black;">จำนวนเงินรวมทั้งสิ้น&nbsp;&nbsp;</td><td align="right" style="border-left:1px solid black; border-top:1px solid black;"><?php if ($vat >0) echo number_format($sum-($discount+($sum*$discount2/100))+$tax, 2, '.', ',')."&nbsp;&nbsp;"; else echo number_format($sum-($discount+($sum*$discount2/100)), 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
</tbody>
<?php
...
<tbody>
<tr>
<td align="center" width="116">เงินสด<br/><?php if ($vat >0) echo number_format($sum-($discount+($sum*$discount2/100))+$tax, 2, '.', ',')."&nbsp;&nbsp;"; else echo number_format($sum-($discount+($sum*$discount2/100)), 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
...
<td align="center" width="120" style="border-left:1px solid black;">ยอดจ่ายสุทธิ<br/><?php if ($vat >0) echo number_format($sum-($discount+($sum*$discount2/100))+$tax, 2, '.', ',')."&nbsp;&nbsp;"; else echo number_format($sum-($discount+($sum*$discount2/100)), 2, '.', ',')."&nbsp;&nbsp;"; ?></td>
</tr>
</tbody>
</table>
<table style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-spacing:0px 0px;">

		...
		<div class="row">
			<div class="col-md-8">
					<div class="form-group">
                        <a data-toggle="modal" data-target="#myModal_all" class="btn btn-success" data-title="View" data-toggle="tooltip" data-target="#view" data-placement="top" rel="tooltip" title="" data-backdrop="static" data-keyboard="false">Export Excel ทั้งหมด</a>
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title">	                 	
										<strong>เลือกรหัสสินค้า</strong> 
									</h4>
								</div>            <!-- /modal-header -->
								<div class="modal-body">
									<form class="form-inline" role="form" action="<?php echo site_url("managestock/historystockexcel_return"); ?>" method="POST" >
									<div class="form-group">
								    <label for="">รหัสสินค้า : </label>
								        <input type="text" class="form-control" id="productid" name="productid" />
                                        <br><br><font color="red">* ถ้าไม่ใส่รหัสสินค้า โปรแกรมจะแสดงสินค้าทั้งหมด </font>
									</div>

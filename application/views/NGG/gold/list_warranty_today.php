        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box_heading"><h1 class="box-title">บัตรรับประกันสินค้า (ทอง) | สาขา <span class="text-blue"><?php foreach($shop_array as $loop) echo $loop->sh_name; ?> </span></h1></div>
                    <div class="box-body">
                    ...
                    <div class="panel-body table-responsive">
                            <table class="table table-hover" id="tablefinal" width="100%">
								...
								<tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $loop->ngw_number; if ($loop->ngw_enable=='V') echo " <button class='btn btn-xs btn-danger'>ยกเลิก (Void)</button>"; ?></td>

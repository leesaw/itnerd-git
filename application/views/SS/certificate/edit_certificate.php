		...
		<div class="row">
            <div class="col-xs-6">
                ...
                <div class="panel panel-warning">
                    ...
                    foreach($cer_array as $loop_main) { ?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form name="form1" id="form1" action="<?php echo site_url('ss_certificate/edit'); ?>" method="post">
                                <input type="hidden" name="cer_id" value="<?php echo $loop_main->cer_id; ?>">
                                <div class="form-group">
                                    <label>CERTIFICATE NUMBER *</label>
                                    <input type="text" class="form-control" name="number" id="number" value="<?php echo $loop_main->cer_number; ?>" readonly>
                                </div>
							</div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php foreach($naturaldiamond_array as $loop){
                                            ...
                                            if ($loop_main->cer_naturaldiamond_id==$loop->id) echo " selected";
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="shape" id="shape">
                                        ...
                                        <?php foreach($shape_array as $loop){
                                                echo "<option value='".$loop->id."'";
                                                if ($loop_main->cer_shape_id==$loop->id) echo " selected";
                                                echo ">".$loop->value."</option>";
                                         } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
									<div class="form-group">
										...
										<?php foreach($cuttingstyle_array as $loop){
												echo "<option value='".$loop->id."'";
                                                if ($loop_main->cer_cuttingstyle_id==$loop->id) echo " selected";
                                                echo ">".$loop->value."</option>";
										 } ?>
                                        </select>
                                    </div>
						...
						<div class="row">
                            <div class="col-md-6">
									<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="measurement" id="measurement" value="<?php echo $loop_main->cer_measurement; ?>" required>
                            ...
                            <div class="col-md-6">
									<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="carat" id="carat" value="<?php echo $loop_main->cer_carat; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php foreach($color_array as $loop){
                                            echo "<option value='".$loop->id."'";
                                            if ($loop_main->cer_color_id==$loop->id) echo " selected";
                                            echo ">".$loop->value."</option>";
                                     } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
									<div class="form-group">
										...
										<?php foreach($clarity_array as $loop){
												echo "<option value='".$loop->id."'";
                                                if ($loop_main->cer_clarity_id==$loop->id) echo " selected";
                                                echo ">".$loop->value."</option>";
										 } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php foreach($fluorescence_array as $loop){
                                            echo "<option value='".$loop->id."'";
                                            if ($loop_main->cer_fluorescence_id==$loop->id) echo " selected";
                                            echo ">".$loop->value."</option>";
                                     } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <?php foreach($proportion_array as $loop){
                                            echo "<option value='".$loop->id."'";
                                            if ($loop_main->cer_proportion_id==$loop->id) echo " selected";
                                            echo ">".$loop->value."</option>";
                                     } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <?php foreach($symmetry_array as $loop){
                                            echo "<option value='".$loop->id."'";
                                            if ($loop_main->cer_symmetry_id==$loop->id) echo " selected";
                                            echo ">".$loop->value."</option>";
                                     } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <?php foreach($polish_array as $loop){
                                            echo "<option value='".$loop->id."'";
                                            if ($loop_main->cer_polish_id==$loop->id) echo " selected";
                                            echo ">".$loop->value."</option>";
                                     } ?>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="totaldepth" id="totaldepth" value="<?php echo $loop_main->cer_totaldepth; ?>">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="totalsize" id="totalsize" value="<?php echo $loop_main->cer_tablesize; ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="crownheight" id="crownheight" value="<?php echo $loop_main->cer_crownheight; ?>">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="crownangle" id="crownangle" value="<?php echo $loop_main->cer_crownangle; ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="starlength" id="starlength" value="<?php echo $loop_main->cer_starlength; ?>">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="paviliondepth" id="paviliondepth" value="<?php echo $loop_main->cer_paviliondepth; ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="pavilionangle" id="pavilionangle" value="<?php echo $loop_main->cer_pavilionangle; ?>">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" class="form-control" name="lowerhalflength" id="lowerhalflength" value="<?php echo $loop_main->cer_lowerhalflength; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <?php foreach($girdlefinish_array as $loop){
                                        echo "<option value='".$loop->id."'";
                                        if ($loop_main->cer_girdlefinish_id==$loop->id) echo " selected";
                                        echo ">".$loop->value."</option>";
                                 } ?>
                                </select>
							</div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <?php foreach($culet_array as $loop){
                                        echo "<option value='".$loop->id."'";
                                        if ($loop_main->cer_culet_id==$loop->id) echo " selected";
                                        echo ">".$loop->value."</option>";
                                 } ?>
                                </select>
							</div>
            ...
            <div class="row">
							<div class="col-md-6">
									<button type="button" name="savebtn" id="savebtn"  class="btn btn-primary" onclick="disablebutton()"><i class='fa fa-save'></i>  บันทึกแก้ไข </button>
                                    &nbsp;&nbsp;&nbsp;
									<button type="button" class="btn btn-warning" onClick="window.location.href='<?php echo site_url("ss_certificate/view_all_certificate"); ?>'"> ยกเลิก </button>
							</div>
						</div>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Sale Report <small>NGG Timepieces</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <form action="<?php echo site_url("jes_salereport/salereport_filter"); ?>" method="post" target="_blank">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <?php if(is_array($whtype_array)) { 						                      						foreach($whtype_array as $loop){ if ($loop->WTCode != 'HQ') {
                                    $wh_array[] = $loop->WTCode; ?>
                                            <div class="checkbox">
                                                <label>

...
function GetLangOpts($llcc, $adobeCJK) {
	...
	//	else { $unifonts = ""; }
	  ...
	  // THAI
	  CASE "th":  $unifonts = "garuda,garudaB,garudaI,garudaBI,norasi,norasiB,norasiI,norasiBI,thsaraban,thsarabanI, thsarabanB, thsarabanBI, thangsana, thangsanaB, thangsanaI, thangsanaBI";  break;

...
Class Ss_certificate_model extends CI_Model
{
 ...
 {
	$this->db->select("cer_id, cer_number, cer_naturaldiamond_id, cer_shape_id, cer_cuttingstyle_id, cer_measurement, cer_carat, cer_color_id, cer_clarity_id, cer_proportion_id, cer_symmetry_id, cer_polish_id, cer_totaldepth, cer_tablesize, cer_crownheight, cer_crownangle, cer_starlength, cer_paviliondepth, cer_pavilionangle, cer_lowerhalflength, cer_girdlethickness, cer_girdlefinish_id, cer_culet_id, cer_girdleinscription, cer_fluorescence_id, cer_softwareresult, cer_status, cer_enable, lcl_value as clarity, lco_value as color, lct_value as culet, lcs_value as cuttingstyle, lfu_value as fluorescence, lgf_value as girdlefinish, cer_girdleinscription, cer_girdlethickness, lnd_value as naturaldiamond, lpo_value as polish, lpt_value as proportion, lpt_id, lct_id, lgf_id, lsh_value as shape, lsm_value as symmetry, cer_comment, cer_symbol");

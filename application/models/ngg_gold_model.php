...
{
    $this->db->select("ngw_id, ngw_number, ngw_product, ngw_kindgold, ngw_price, ngw_payment, ngw_code, ngw_weight, ngw_jewelry, ngw_datestart, ngw_old, ngw_model, ngw_goldbuy, ngw_goldsell, ngw_customername, ngw_customertelephone, ngw_customeraddress, ngw_saleperson_id, sp_firstname, sp_lastname, ngw_issuedate, ngw_shop_id, sh_name, sh_telephone, ngw_status, ngw_dateadd, ngw_dateaddby, firstname, lastname, ngw_remark, ngw_enable");
